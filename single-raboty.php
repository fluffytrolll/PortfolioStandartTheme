...
<section class="aw-single aw-block" id="top">
  <article class="aw-article" itemscope itemtype="https://schema.org/Article">
    <?php if (have_posts()):
            ...
            <section>
              ...
              while ($query->have_posts()) {
                ...
                <article class="aw-post-card aw-post-card_recomendation" itemscope itemtype="http://schema.org/BlogPosting">
                  ...
                  <a class="aw-post-card__link" aria-label="Отрыть рекомендованную работу из портфолио"
                    href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" itemprop="url"></a>
                </article>
      ...
      <?php endwhile; else: ?>
    <p>Не получилось найти работу...</p>
    <?php endif; ?>
  </article>
</section>

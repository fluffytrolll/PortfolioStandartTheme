<section class="aw-offer aw-block" id="top">
  <div class="aw-offer__wrapper">
    <div class="aw-offer__content aw-offer__content_background aw-block__rounded">
      <div class="aw-offer__heading">
        <h1 class="aw-offer__title">Привет, Я Артём,<br />Frontend разработчик<br />с 3х-летним стажем.</h1>
        <p class="aw-offer__text">Я стараюсь создавать прогрессивные и качесвтенные<br />веб-приложения. Моя основная
          цель - это доступность,<br />скорость и лучший пользовательский опыт.</p>
      </div>
      <div class="aw-offer__links">
        <a class="aw-button-link" href="#kontacty">Свяжитесь со мной</a>
        <div class="aw-socials">
          <span class="aw-socials__item">
            <svg class="aw-socials__icon" width="24" height="25" viewBox="0 0 24 25" fill="none"
    ...
    <div class="aw-offer__photo aw-block__rounded">
      <?php getMyPhotos(); ?>
    </div>
  </div>
</section>